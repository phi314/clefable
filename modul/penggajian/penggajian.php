<script language="javascript" src="modul/penggajian/ajax.js"></script>
<style type="text/css">
button {
	margin: 2px; 
	position: relative; 
...
<div title=\"Tambah Transaksi Kas\" style=\"padding:10px\">
	<div id=\"p\" class=\"easyui-panel\" title=\"Penggajian\" style=\"float:left;width:980px;padding:5px;margin-buttom:10px;\">
	<table width='100%'>
	<tr>
...
<div title=\"Daftar Transaksi Penggajian\" style=\"padding:10px\">
	<div id='menu-tombol'>
	<div id='tombol-cari'>
